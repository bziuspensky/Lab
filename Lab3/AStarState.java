...
public class AStarState
{
    ...
    {
         //Если нет открытых путевых точек, по возвращаем пустоту
        if (numOpenWaypoints() == 0)
            return null;
        
		//Создаем ключи и представления карты. Ссылку на объект Waypoint. Переменную для хранения лучшей цены
        ...
        while (i.hasNext())
        {
			...
			//Если текущая стоимость меньше значения best_cost, до переназначаем значения best и best_cost на текущие
